...
<body>
    <div class="nav2 flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <h1 class="titulo">LISTADO DE VOLUNTARIOS</h1> 
      <div class="contenedor">
        <c:choose>
        <c:when test="${empty voluntarios}">
        <div><br/><br/><h3>No hay voluntarios registrados en este momento</h3></div>
        </c:when>
        <c:when test="${!empty voluntarios}">  
        ...
        <table class="table table-bordered">
                ...
                <tbody>
                   <c:forEach var="n" items="${requestScope.voluntarios}">
	                  <tr>
	                    <th>${n.nombre}</th>
