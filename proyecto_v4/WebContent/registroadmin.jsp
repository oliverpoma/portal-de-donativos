...
<body>
    ...
    <h2 style="background-color: #bbe0ff87;">Usted va a registrarse como administrador</h2>
 	<h3 style="background-color: #bbe0ff87;">Si no es administrador o desea volver a inicio haga click a VOLVER A INICIO al final de formulario</h3>
        <div class="col-sm-8 main-section">
            <div class="modal-content">
                <div class="col-12 user-img">
                    <img src="formulario/img/Login.png"/>
                </div>
                <form class="col-12" action="RegistrarAction?idRol=1" method="post">
                    ...
                    <div class="form-check" id="check-group">
                        ...
                        <label class="form-group-label" for="gridCheck1">Soy mayor de edad</label>
